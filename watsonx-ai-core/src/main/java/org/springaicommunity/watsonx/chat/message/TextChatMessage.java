 ...
 * @param textChatUserContent The content of the message, which can be text or structured
 * data.
...
public record TextChatMessage(@JsonProperty("role") ChatRole role, @JsonProperty("name") String name,
		@JsonProperty("content") Object textChatUserContent, @JsonProperty("refusal") String refusal,
		@JsonProperty("tool_calls") List<TextChatToolCall> toolCalls, @JsonProperty("tool_call_id") String toolCallId) {
	 ...
	 * @param toolCalls The tool calls generated by the model, such as function calls.
	 */
	public TextChatMessage(final String content, final String name, final String refusal,
