...
public class WatsonxAiChatModelTest {
	...
	void chatOptionsConfiguration() {
		...
		WatsonxAiChatOptions customOptions = WatsonxAiChatOptions.builder()
	...
	void chatModelCallSimulation() {
		...
		WatsonxAiChatResponse.TextChatResultChoice choice = new WatsonxAiChatResponse.TextChatResultChoice(0,
				new WatsonxAiChatResponse.TextChatResultMessage(
						org.springaicommunity.watsonx.chat.util.ChatRole.ASSISTANT, "Hello! How can I help you today?",
						null, null),
				"stop", null);

		WatsonxAiChatResponse mockResponse = new WatsonxAiChatResponse("test-id", "ibm/granite-3-3-8b-instruct",
				1234567890, List.of(choice), "2024-01-01", null, new WatsonxAiChatResponse.TextChatUsage(10, 15, 25),
				null);

		when(watsonxAiChatApi.chat(any(WatsonxAiChatRequest.class))).thenReturn(ResponseEntity.ok(mockResponse));
	...
	void chatModelCallAddsLogprobsMetadataWhenRequested() {
		WatsonxAiChatResponse.TextChatLogProbs logprobs = new WatsonxAiChatResponse.TextChatLogProbs(List
			.of(new WatsonxAiChatResponse.TextChatLogProbsContent("Hello", -0.123, List.of(72, 101, 108, 108, 111),
					List.of(new WatsonxAiChatResponse.TextChatTopLogProbs("Hello", -0.123,
							List.of(72, 101, 108, 108, 111)),
							new WatsonxAiChatResponse.TextChatTopLogProbs("Hi", -1.456, List.of(72, 105))))),
				null);
		...
		WatsonxAiChatResponse mockResponse = new WatsonxAiChatResponse("test-id", "ibm/granite-3-3-8b-instruct",
				1234567890, List.of(choice), "2024-01-01", null, new WatsonxAiChatResponse.TextChatUsage(10, 1, 11),
				null);
		...
		ChatResponse response = chatModel.call(prompt);
		var metadataLogprobs = (WatsonxAiChatResponse.TextChatLogProbs) response.getResult()
			.getMetadata()
			.get("logprobs");
		...
		ArgumentCaptor<WatsonxAiChatRequest> requestCaptor = ArgumentCaptor.forClass(WatsonxAiChatRequest.class);
	...
	void chatModelCallDoesNotAddLogprobsMetadataWhenNotRequested() {
		WatsonxAiChatResponse.TextChatLogProbs logprobs = new WatsonxAiChatResponse.TextChatLogProbs(
				List.of(new WatsonxAiChatResponse.TextChatLogProbsContent("Hello", -0.123,
						List.of(72, 101, 108, 108, 111), List.of())),
				null);
	...
	void chatModelBuilder() {
		WatsonxAiChatModel customChatModel = WatsonxAiChatModel.builder()
			.watsonxAiChatApi(watsonxAiChatApi)
	...
	@Test
	void optionsCopy() {
		WatsonxAiChatOptions original = WatsonxAiChatOptions.builder().model("original-model").temperature(0.3).build();
