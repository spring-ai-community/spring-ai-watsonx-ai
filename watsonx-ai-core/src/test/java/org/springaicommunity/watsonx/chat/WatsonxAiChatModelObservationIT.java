...
/**
 * Integration test for WatsonxAiChatModel observation and metrics. This test verifies
 * that the chat model properly integrates with Micrometer's observation framework for
...
public class WatsonxAiChatModelObservationIT {
	...
	void chatOperationPreservesMetadata() {
		...
		org.assertj.core.api.Assertions.assertThat(response.getMetadata().getId()).isEqualTo("cmpl-metadata-999");
