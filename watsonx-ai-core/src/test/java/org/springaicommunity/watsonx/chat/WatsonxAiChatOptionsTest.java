...
/**
 * JUnit 5 test class for WatsonxAiChatOptions functionality and configuration. Tests the
 * chat options builder pattern and configuration validation.
 *
...
class WatsonxAiChatOptionsTest {
	...
	class BasicOptionsTests {
		...
		void createBasicChatOptionsWithDefaultValues() {
			...
			assertAll("Basic options validation", () -> assertEquals("ibm/granite-3-3-8b-instruct", options.getModel()),
					() -> assertEquals(0.7, options.getTemperature()), () -> assertEquals(1.0, options.getTopP()),
					() -> assertEquals(1024, options.getMaxTokens()));
		}

		@Test
		void createOptionsWithMinimumRequiredFields() {
			WatsonxAiChatOptions options = WatsonxAiChatOptions.builder().model("ibm/granite-3-8b-instruct").build();

			assertAll("Minimal options validation", () -> assertEquals("ibm/granite-3-8b-instruct", options.getModel()),
					() -> assertNull(options.getTemperature()), () -> assertNull(options.getTopP()),
	...
	class AdvancedOptionsTests {
		...
		void createAdvancedOptionsWithAllParameters() {
			...
			assertAll("Advanced options validation",
					() -> assertEquals("ibm/granite-3-8b-instruct", options.getModel()),
					() -> assertEquals(0.3, options.getTemperature()), () -> assertEquals(0.9, options.getTopP()),
					...
					() -> assertEquals(42, options.getSeed()), () -> assertEquals(1, options.getN()));
		}
	...
	class ModelSelectionTests {
		...
		void supportDifferentIBMGraniteModels() {
			String[] supportedModels = { "ibm/granite-3-3-8b-instruct", "ibm/granite-3-8b-instruct",
					"ibm/granite-3-2b-instruct" };

			for (String model : supportedModels) {
				WatsonxAiChatOptions options = WatsonxAiChatOptions.builder().model(model).temperature(0.7).build();
	...
	class ParameterRangeTests {
		...
		void acceptValidTemperatureRange() {
			assertAll("Temperature range validation", () -> {
		...
		void acceptValidTopPRange() {
			assertAll("TopP range validation", () -> {
		...
		void acceptVariousTokenLimits() {
			assertAll("Token limit validation", () -> {
				WatsonxAiChatOptions shortTokens = WatsonxAiChatOptions.builder().maxTokens(256).build();
				assertEquals(256, shortTokens.getMaxTokens());
			}, () -> {
				WatsonxAiChatOptions longTokens = WatsonxAiChatOptions.builder().maxTokens(4096).build();
	...
	class ChatBehaviorTests {
		...
		void configureCreativeChatBehavior() {
			WatsonxAiChatOptions creative = WatsonxAiChatOptions.builder()
				.model("ibm/granite-3-3-8b-instruct")
			...
			assertAll("Creative behavior validation", () -> assertEquals(0.9, creative.getTemperature()),
		...
		void configureFocusedChatBehavior() {
			WatsonxAiChatOptions focused = WatsonxAiChatOptions.builder()
				.model("ibm/granite-3-3-8b-instruct")
			...
			assertAll("Focused behavior validation", () -> assertEquals(0.2, focused.getTemperature()),
					() -> assertEquals(0.7, focused.getTopP()), () -> assertEquals(0.0, focused.getPresencePenalty()));
		}
	...
	class BuilderPatternTests {
		...
		void createMultipleInstancesIndependently() {
			WatsonxAiChatOptions options1 = WatsonxAiChatOptions.builder()
				.model("ibm/granite-3-3-8b-instruct")
				.temperature(0.5)
				.build();

			WatsonxAiChatOptions options2 = WatsonxAiChatOptions.builder()
				.model("ibm/granite-3-8b-instruct")
				.temperature(0.8)
				.build();

			assertAll("Multiple instances validation", () -> assertNotSame(options1, options2),
	...
	class ValidationTests {
		...
		void validateOptionsState() {
			...
			assertAll("Options validation", () -> assertNotNull(options),
	...
	class CopyMethodTests {
		...
		void copyCreatesSeparateInstance() {
			...
			assertAll("Copy creates separate instance", () -> assertNotSame(original, copy),
		...
		void copyWithNullFieldsHandledCorrectly() {
			...
			assertAll("Copy with null fields", () -> assertNotSame(original, copy),
					() -> assertEquals(original.getModel(), copy.getModel()), () -> assertNull(copy.getTemperature()),
					() -> assertNull(copy.getTopP()), () -> assertNull(copy.getMaxTokens()));
		}
	...
	class ToStringMethodTests {
		...
		void toStringReturnsJsonRepresentation() {
			...
			assertAll("ToString validation", () -> assertNotNull(result),
	...
	class EqualsMethodTests {
		...
		void equalsReturnsTrueForSameInstance() {
			WatsonxAiChatOptions options = WatsonxAiChatOptions.builder().model("test-model").temperature(0.7).build();
		...
		void equalsReturnsFalseForDifferentModel() {
			WatsonxAiChatOptions options1 = WatsonxAiChatOptions.builder().model("model1").temperature(0.7).build();

			WatsonxAiChatOptions options2 = WatsonxAiChatOptions.builder().model("model2").temperature(0.7).build();
		...
		void equalsReturnsFalseForDifferentTemperature() {
			WatsonxAiChatOptions options1 = WatsonxAiChatOptions.builder().model("test-model").temperature(0.7).build();

			WatsonxAiChatOptions options2 = WatsonxAiChatOptions.builder().model("test-model").temperature(0.5).build();
	...
	class ResponseFormatTests {
		...
		void createOptionsWithJsonObjectResponseFormat() {
			...
			assertAll("JSON object response format validation", () -> assertNotNull(options.getResponseFormat()),
					() -> assertEquals(TextChatResponseFormat.Type.JSON_OBJECT, options.getResponseFormat().getType()));
		}
		...
		void createOptionsWithTextResponseFormat() {
			...
			assertAll("Text response format validation", () -> assertNotNull(options.getResponseFormat()),
					() -> assertEquals(TextChatResponseFormat.Type.TEXT, options.getResponseFormat().getType()));
		}

		@Test
		void createOptionsWithoutResponseFormat() {
			WatsonxAiChatOptions options = WatsonxAiChatOptions.builder().model("ibm/granite-3-3-8b-instruct").build();
		...
		void copyIncludesResponseFormat() {
			...
			assertAll("Copy includes response format", () -> assertNotSame(original, copy),
					() -> assertNotNull(copy.getResponseFormat()),
					() -> assertEquals(TextChatResponseFormat.Type.JSON_OBJECT, copy.getResponseFormat().getType()));
		}
		...
		void equalsConsidersResponseFormat() {
			...
			WatsonxAiChatOptions options3 = WatsonxAiChatOptions.builder()
				.model("test-model")
				.responseFormat(TextChatResponseFormat.text())
				.build();

			assertAll("Equals considers response format", () -> assertEquals(options1, options2),
	...
	class GuidedOptionsTests {
		...
		void createOptionsWithGuidedChoice() {
			...
			assertAll("Guided choice validation", () -> assertNotNull(options.getGuidedChoice()),
		...
		void createOptionsWithGuidedRegex() {
			...
			assertAll("Guided regex validation", () -> assertNotNull(options.getGuidedRegex()),
		...
		void createOptionsWithGuidedGrammar() {
			...
			assertAll("Guided grammar validation", () -> assertNotNull(options.getGuidedGrammar()),
		...
		void createOptionsWithGuidedJsonAsMap() {
			...
			assertAll("Guided JSON validation", () -> assertNotNull(options.getGuidedJson()),
		...
		void createOptionsWithGuidedJsonAsString() {
			...
			assertAll("Guided JSON string validation", () -> assertNotNull(options.getGuidedJson()),
					() -> assertEquals("object", options.getGuidedJson().get("type")),
					() -> assertTrue(options.getGuidedJson().containsKey("properties")));
		}
		...
		void copyIncludesGuidedOptions() {
			...
			assertAll("Copy includes guided options", () -> assertNotSame(original, copy),
		...
		void equalsConsidersGuidedOptions() {
			...
			assertAll("Equals considers guided options", () -> assertEquals(options1, options2),
					() -> assertNotEquals(options1, options3));
		}
	...
	class ChatTemplateKwargsTests {
		...
		void createOptionsWithChatTemplateKwargsAsMap() {
			...
			assertAll("Chat template kwargs validation", () -> assertNotNull(options.getChatTemplateKwargs()),
		...
		void createOptionsWithChatTemplateKwargsAsString() {
			...
			assertAll("Chat template kwargs string validation", () -> assertNotNull(options.getChatTemplateKwargs()),
					() -> assertEquals("You are a helpful assistant",
							options.getChatTemplateKwargs().get("system_prompt")),
					() -> assertEquals(10, options.getChatTemplateKwargs().get("max_history")));
		}
		...
		void copyIncludesChatTemplateKwargs() {
			...
			assertAll("Copy includes chat template kwargs", () -> assertNotSame(original, copy),
		...
		void equalsConsidersChatTemplateKwargs() {
			...
			assertAll("Equals considers chat template kwargs", () -> assertEquals(options1, options2),
					() -> assertNotEquals(options1, options3));
		}
	...
	class ReasoningOptionsTests {
		...
		void createOptionsWithIncludeReasoningTrue() {
			...
			assertAll("Include reasoning true validation", () -> assertNotNull(options.isIncludeReasoning()),
		...
		void createOptionsWithIncludeReasoningFalse() {
			...
			assertAll("Include reasoning false validation", () -> assertNotNull(options.isIncludeReasoning()),
		...
		void includeReasoningDefaultsToTrue() {
			...
			assertAll("Include reasoning default validation", () -> assertNotNull(options.isIncludeReasoning()),
					() -> assertTrue(options.isIncludeReasoning()));
		}
		...
		void createOptionsWithReasoningEffortLow() {
			...
			assertAll("Reasoning effort low validation", () -> assertNotNull(options.getReasoningEffort()),
		...
		void createOptionsWithReasoningEffortMedium() {
			...
			assertAll("Reasoning effort medium validation", () -> assertNotNull(options.getReasoningEffort()),
		...
		void createOptionsWithReasoningEffortHigh() {
			...
			assertAll("Reasoning effort high validation", () -> assertNotNull(options.getReasoningEffort()),
		...
		void copyIncludesReasoningOptions() {
			...
			assertAll("Copy includes reasoning options", () -> assertNotSame(original, copy),
		...
		void equalsConsidersReasoningOptions() {
			...
			assertAll("Equals considers reasoning options", () -> assertEquals(options1, options2),
					() -> assertNotEquals(options1, options3));
		}
		...
		void setReasoningEffortValidatesAllowedValues() {
			...
			assertAll("Reasoning effort validation", () -> assertDoesNotThrow(() -> options.setReasoningEffort("low")),
		...
		void setReasoningEffortThrowsForInvalidValue() {
			...
			assertThrows(IllegalArgumentException.class, () -> options.setReasoningEffort("invalid"),
