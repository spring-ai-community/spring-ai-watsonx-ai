...
/**
 * JUnit 5 test class for WatsonxAiEmbeddingModel functionality. Tests embedding model
...
class WatsonxAiEmbeddingModelTest {
	...
	void setUp() throws Exception {
		...
		defaultOptions = WatsonxAiEmbeddingOptions.builder()
			.model("ibm/slate-125m-english-rtrvr")
			.parameters(parameters)
			.build();

		// Initialize the embedding model
		embeddingModel = new WatsonxAiEmbeddingModel(watsonxAiEmbeddingApi, defaultOptions, ObservationRegistry.NOOP,
				retryTemplate);
	...
	class ConstructorTests {
		...
		void constructorWithNullApiThrowsException() {
			assertThrows(IllegalArgumentException.class,
					() -> new WatsonxAiEmbeddingModel(null, defaultOptions, ObservationRegistry.NOOP, retryTemplate),
					"WatsonxAiEmbeddingApi must not be null");
		}

		@Test
		void constructorWithNullOptionsThrowsException() {
			assertThrows(IllegalArgumentException.class, () -> new WatsonxAiEmbeddingModel(watsonxAiEmbeddingApi, null,
					ObservationRegistry.NOOP, retryTemplate), "WatsonxAiEmbeddingOptions must not be null");
		}

		@Test
		void constructorWithNullObservationRegistryThrowsException() {
			assertThrows(IllegalArgumentException.class,
					() -> new WatsonxAiEmbeddingModel(watsonxAiEmbeddingApi, defaultOptions, null, retryTemplate),
					"ObservationRegistry must not be null");
		}

		@Test
		void constructorWithNullRetryTemplateThrowsException() {
			assertThrows(IllegalArgumentException.class, () -> new WatsonxAiEmbeddingModel(watsonxAiEmbeddingApi,
	...
	class CallMethodTests {
		...
		void callWithValidRequest() {
			...
			WatsonxAiEmbeddingResponse.Embedding result1 = new WatsonxAiEmbeddingResponse.Embedding(
					List.of(0.1, 0.2, 0.3), new WatsonxAiEmbeddingResponse.EmbeddingInputResult("Hello world"));
			WatsonxAiEmbeddingResponse.Embedding result2 = new WatsonxAiEmbeddingResponse.Embedding(
					List.of(0.4, 0.5, 0.6), new WatsonxAiEmbeddingResponse.EmbeddingInputResult("How are you?"));

			WatsonxAiEmbeddingResponse mockResponse = new WatsonxAiEmbeddingResponse("ibm/slate-125m-english-rtrvr",
					LocalDateTime.now(), List.of(result1, result2), 7);
		...
		void callWithNullRequestThrowsException() {
			assertThrows(IllegalArgumentException.class, () -> embeddingModel.call(null),
		...
		void callWithEmptyInstructionsThrowsException() {
			...
			assertThrows(IllegalArgumentException.class, () -> embeddingModel.call(request),
		...
		void callWithCustomOptions() {
			WatsonxAiEmbeddingRequest.EmbeddingReturnOptions returnOptions = new WatsonxAiEmbeddingRequest.EmbeddingReturnOptions(
					true);
			WatsonxAiEmbeddingRequest.EmbeddingParameters parameters = new WatsonxAiEmbeddingRequest.EmbeddingParameters(
					1024, returnOptions);
			...
			WatsonxAiEmbeddingResponse.Embedding result = new WatsonxAiEmbeddingResponse.Embedding(List.of(0.1, 0.2),
					new WatsonxAiEmbeddingResponse.EmbeddingInputResult("test"));

			WatsonxAiEmbeddingResponse mockResponse = new WatsonxAiEmbeddingResponse("custom-model",
					LocalDateTime.now(), List.of(result), 1);
	...
	class EmbedDocumentTests {
		...
		void embedDocumentWithValidDocument() {
			...
			WatsonxAiEmbeddingResponse.Embedding result = new WatsonxAiEmbeddingResponse.Embedding(
					List.of(0.1, 0.2, 0.3),
					new WatsonxAiEmbeddingResponse.EmbeddingInputResult("This is a test document"));

			WatsonxAiEmbeddingResponse mockResponse = new WatsonxAiEmbeddingResponse("ibm/slate-125m-english-rtrvr",
					LocalDateTime.now(), List.of(result), 5);
		...
		void embedDocumentWithNullDocumentThrowsException() {
			assertThrows(IllegalArgumentException.class, () -> embeddingModel.embed((Document) null),
	...
	class EmbedTextTests {
		...
		void embedTextWithValidString() {
			...
			WatsonxAiEmbeddingResponse.Embedding result = new WatsonxAiEmbeddingResponse.Embedding(
					List.of(0.7, 0.8, 0.9), new WatsonxAiEmbeddingResponse.EmbeddingInputResult("Hello world"));

			WatsonxAiEmbeddingResponse mockResponse = new WatsonxAiEmbeddingResponse("ibm/slate-125m-english-rtrvr",
					LocalDateTime.now(), List.of(result), 2);
		...
		void embedTextWithNullTextThrowsException() {
			assertThrows(IllegalArgumentException.class, () -> embeddingModel.embed((String) null),
					"Text must not be null or empty");
		}

		@Test
		void embedTextWithEmptyTextThrowsException() {
			assertThrows(NullPointerException.class, () -> embeddingModel.embed(""), "Text must not be null or empty");
		}
	...
	class OptionsMergingTests {
		...
		void mergeOptionsWithRuntimeModel() {
			WatsonxAiEmbeddingOptions runtimeOptions = WatsonxAiEmbeddingOptions.builder()
				.model("runtime-model")
				.build();

			EmbeddingRequest request = new EmbeddingRequest(List.of("test"), runtimeOptions);

			WatsonxAiEmbeddingResponse.Embedding result = new WatsonxAiEmbeddingResponse.Embedding(List.of(0.1),
					new WatsonxAiEmbeddingResponse.EmbeddingInputResult("test"));
			WatsonxAiEmbeddingResponse mockResponse = new WatsonxAiEmbeddingResponse("runtime-model",
					LocalDateTime.now(), List.of(result), 1);
		...
		void mergeOptionsWithEncodingFormat() {
			WatsonxAiEmbeddingOptions runtimeOptions = WatsonxAiEmbeddingOptions.builder()
				.model("custom-model")
				.encodingFormat("float") // This should be ignored for Watson AI but not
											// cause errors
				.build();
		...
		void mergeOptionsWithNonWatsonxOptions() {
			// Test that generic EmbeddingOptions (not WatsonxAiEmbeddingOptions) are
			// handled correctly
			org.springframework.ai.embedding.EmbeddingOptions genericOptions = new org.springframework.ai.embedding.EmbeddingOptions() {
				@Override
			...
			WatsonxAiEmbeddingResponse.Embedding result = new WatsonxAiEmbeddingResponse.Embedding(List.of(0.1),
					new WatsonxAiEmbeddingResponse.EmbeddingInputResult("test"));
			WatsonxAiEmbeddingResponse mockResponse = new WatsonxAiEmbeddingResponse("generic-model",
					LocalDateTime.now(), List.of(result), 1);
	...
	class ResponseHandlingTests {
		...
		void handleNullResponse() {
			...
			when(watsonxAiEmbeddingApi.embed(any(WatsonxAiEmbeddingRequest.class))).thenReturn(ResponseEntity.ok(null));
		...
		void handleResponseWithNullResults() {
			...
			WatsonxAiEmbeddingResponse mockResponse = new WatsonxAiEmbeddingResponse("test-model", LocalDateTime.now(),
					null, 1);
		...
		void handleResponseWithNullModelId() {
			...
			WatsonxAiEmbeddingResponse mockResponse = new WatsonxAiEmbeddingResponse(null, LocalDateTime.now(),
					List.of(result), 1);
		...
		void handleResponseWithNullInputTokenCount() {
			...
			assertNotNull(response);
			assertEquals(0, response.getResults().get(0).getIndex()); // Should default to
																		// 0
		}
	...
	class ParameterCreationTests {
		...
		void createEmbeddingParametersWithTruncateTokensOnly() {
			...
			WatsonxAiEmbeddingOptions options = WatsonxAiEmbeddingOptions.builder()
				.model("test-model")
				.parameters(parameters)
				.build();
		...
		void createEmbeddingParametersWithNullValues() {
			WatsonxAiEmbeddingOptions options = WatsonxAiEmbeddingOptions.builder().model("test-model").build();
	...
	class DefaultOptionsTests {
		...
		void getDefaultOptionsReturnsCorrectOptions() {
			...
			assertAll("Default options validation", () -> assertEquals(defaultOptions, retrievedOptions),
