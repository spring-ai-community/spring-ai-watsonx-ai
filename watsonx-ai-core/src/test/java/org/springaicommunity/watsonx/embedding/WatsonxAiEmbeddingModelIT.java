...
/**
 * Integration test class for WatsonxAiEmbeddingModel using Spring AI EmbeddingModel APIs.
 * This test demonstrates integration with Spring AI's high-level EmbeddingRequest and
 * EmbeddingResponse APIs.
 *
...
public class WatsonxAiEmbeddingModelIT {
	...
	void embeddingRequestWithMultipleTextsTest() {
		...
		EmbeddingRequest request = new EmbeddingRequest(List.of("First text", "Second text", "Third text"), null);
	...
	void embeddingWithLongTextTest() {
		...
		String longText = "This is a very long text that contains multiple sentences and should be properly "
		...
		assertArrayEquals(new float[] { 0.12f, 0.23f, 0.34f, 0.45f, 0.56f, 0.67f, 0.78f, 0.89f }, embedding, 0.001f);
