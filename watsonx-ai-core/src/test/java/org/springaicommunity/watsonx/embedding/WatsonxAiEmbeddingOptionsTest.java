...
/**
 * JUnit 5 test class for WatsonxAiEmbeddingOptions functionality and configuration. Tests
 * the embedding options builder pattern and configuration validation.
 *
...
class WatsonxAiEmbeddingOptionsTest {
	...
	class BasicOptionsTests {
		...
		void createBasicEmbeddingOptionsWithDefaultValues() {
			...
			assertAll("Basic options validation",
		...
		void createOptionsWithMinimumRequiredFields() {
			...
			assertAll("Minimal options validation",
					() -> assertEquals("ibm/slate-30m-english-rtrvr", options.getModel()),
					() -> assertNull(options.getParameters()), () -> assertNull(options.getDimensions()));
		}
		...
		void createEmptyOptions() {
			...
			assertAll("Empty options validation", () -> assertNull(options.getModel()),
					() -> assertNull(options.getParameters()), () -> assertNull(options.getDimensions()));
		}
	...
	class ModelSelectionTests {
		...
		void supportDifferentIBMSlateModels() {
			String[] supportedModels = { "ibm/slate-125m-english-rtrvr", "ibm/slate-30m-english-rtrvr",
	...
	class ParameterTests {
		...
		void acceptValidTruncateInputTokensRange() {
			assertAll("TruncateInputTokens range validation", () -> {
				WatsonxAiEmbeddingRequest.EmbeddingParameters lowParams = new WatsonxAiEmbeddingRequest.EmbeddingParameters(
						1, null);
				WatsonxAiEmbeddingOptions lowTokens = WatsonxAiEmbeddingOptions.builder().parameters(lowParams).build();
				assertEquals(1, lowTokens.getParameters().truncateInputTokens());
			}, () -> {
				WatsonxAiEmbeddingRequest.EmbeddingParameters midParams = new WatsonxAiEmbeddingRequest.EmbeddingParameters(
						512, null);
				WatsonxAiEmbeddingOptions midTokens = WatsonxAiEmbeddingOptions.builder().parameters(midParams).build();
				assertEquals(512, midTokens.getParameters().truncateInputTokens());
			}, () -> {
				WatsonxAiEmbeddingRequest.EmbeddingParameters highParams = new WatsonxAiEmbeddingRequest.EmbeddingParameters(
						2048, null);
				WatsonxAiEmbeddingOptions highTokens = WatsonxAiEmbeddingOptions.builder()
	...
	class BuilderPatternTests {
		...
		void createMultipleInstancesIndependently() {
			WatsonxAiEmbeddingRequest.EmbeddingParameters params1 = new WatsonxAiEmbeddingRequest.EmbeddingParameters(
					256, null);
			WatsonxAiEmbeddingRequest.EmbeddingParameters params2 = new WatsonxAiEmbeddingRequest.EmbeddingParameters(
					512, null);

			WatsonxAiEmbeddingOptions options1 = WatsonxAiEmbeddingOptions.builder()
				.model("ibm/slate-125m-english-rtrvr")
				.parameters(params1)
				.build();

			WatsonxAiEmbeddingOptions options2 = WatsonxAiEmbeddingOptions.builder()
				.model("ibm/slate-30m-english-rtrvr")
				.parameters(params2)
				.build();
		...
		void supportToBuilderPattern() {
			WatsonxAiEmbeddingRequest.EmbeddingParameters originalParams = new WatsonxAiEmbeddingRequest.EmbeddingParameters(
					256, null);

			WatsonxAiEmbeddingOptions original = WatsonxAiEmbeddingOptions.builder()
				.model("original-model")
				.parameters(originalParams)
				.build();

			WatsonxAiEmbeddingRequest.EmbeddingParameters modifiedParams = new WatsonxAiEmbeddingRequest.EmbeddingParameters(
					512, null);

			WatsonxAiEmbeddingOptions modified = original.toBuilder()
				.model("modified-model")
				.parameters(modifiedParams)
				.build();

			assertAll("ToBuilder pattern validation", () -> assertEquals("original-model", original.getModel()),
	...
	class SetterTests {
		...
		void setEncodingFormatIgnored() {
			...
			assertNull(options.getEncodingFormat()); // Watson AI doesn't support encoding
														// format
		}
	...
	class ValidationTests {
		...
		void validateOptionsState() {
			...
			assertAll("Options validation", () -> assertNotNull(options),
					() -> assertEquals("test-model", options.getModel()), () -> assertNotNull(options.getParameters()),
	...
	class CopyMethodTests {
		...
		void copyWithNullFieldsHandledCorrectly() {
			WatsonxAiEmbeddingOptions original = WatsonxAiEmbeddingOptions.builder().model("test-model").build();

			WatsonxAiEmbeddingOptions copy = original.toBuilder().build();

			assertAll("Copy with null fields", () -> assertNotSame(original, copy),
					() -> assertEquals(original.getModel(), copy.getModel()), () -> assertNull(copy.getParameters()));
		}
	...
	class EqualsMethodTests {
		...
		void equalsReturnsFalseForDifferentModel() {
			WatsonxAiEmbeddingOptions options1 = WatsonxAiEmbeddingOptions.builder().model("model1").build();

			WatsonxAiEmbeddingOptions options2 = WatsonxAiEmbeddingOptions.builder().model("model2").build();
		...
		void equalsHandlesNullFields() {
			WatsonxAiEmbeddingOptions options1 = WatsonxAiEmbeddingOptions.builder().model("test-model").build();

			WatsonxAiEmbeddingOptions options2 = WatsonxAiEmbeddingOptions.builder().model("test-model").build();
