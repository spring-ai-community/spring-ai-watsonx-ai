...
/**
 * Auto-configures the watsonx.ai document reranker when Spring AI RAG is available.
 *
 * @author Ana Katrina Inguengan
 * @since 2.0.0
 */
@AutoConfiguration(after = WatsonxAiRerankAutoConfiguration.class)
@ConditionalOnClass(name = "org.springframework.ai.rag.postretrieval.document.DocumentPostProcessor")
@ConditionalOnSingleCandidate(WatsonxAiRerankModel.class)
public class WatsonxAiDocumentRerankerConfiguration {
