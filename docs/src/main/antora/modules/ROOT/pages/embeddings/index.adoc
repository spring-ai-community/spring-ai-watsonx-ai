...
The https://github.com/spring-ai-community/spring-ai-watsonx-ai/blob/main/watsonx-ai-core/src/main/java/org/springaicommunity/watsonx/embedding/WatsonxAiEmbeddingOptions.java[WatsonxAiEmbeddingOptions.java] provides model configurations, such as the model to use and other parameters.
...
The https://github.com/spring-ai-community/spring-ai-watsonx-ai/blob/main/watsonx-ai-core/src/main/java/org/springaicommunity/watsonx/embedding/WatsonxAiEmbeddingModel.java[WatsonxAiEmbeddingModel] implements the `EmbeddingModel` and uses the <<low-level-api>> to connect to the Watsonx.ai service.
...
The https://github.com/spring-ai-community/spring-ai-watsonx-ai/blob/main/watsonx-ai-core/src/main/java/org/springaicommunity/watsonx/embedding/WatsonxAiEmbeddingApi.java[WatsonxAiEmbeddingApi] provides is a lightweight Java client on top of Watsonx.ai https://cloud.ibm.com/apidocs/watsonx-ai[Embeddings API^].
...
Follow the https://github.com/spring-ai-community/spring-ai-watsonx-ai/blob/main/watsonx-ai-core/src/main/java/org/springaicommunity/watsonx/embedding/WatsonxAiEmbeddingApi.java[WatsonxAiEmbeddingApi.java]'s JavaDoc for further information.

[[embedding-options]]
== WatsonxAiEmbeddingOptions

The https://github.com/spring-ai-community/spring-ai-watsonx-ai/blob/main/watsonx-ai-core/src/main/java/org/springaicommunity/watsonx/embedding/WatsonxAiEmbeddingOptions.java[WatsonxAiEmbeddingOptions] class provides various options for configuring embedding requests:
